...
function isShort(input){
  if(input.hasAttribute("maxlength") && input.value.length !== input.maxLength) return 1;
  else return 0;
}
...
function displayAlert(index) {
  switch(index){
    ...
    case 1: // empty fields
      ...
      if (emptyFieldCount == 1)  submissionAlert.textContent = "A field missing.";
      else alertH1.textContent = "Some fields are missing.";
      break;
    ...
    case 2: // invalid length fields
      ...
      if(shortFieldCount == 1) submissionAlert.textContent = "A field does not have the expected length.";
      else submissionAlert.textContent = "Some fields do not have the expected length.";
      break;
    ...
    case 3: // empty fields and invalid length
      ...
      submissionAlert.textContent = "Some fields are missing and some others do not have the expected length.";
      break;
  }
